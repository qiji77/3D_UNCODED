...
class SURREAL(data.Dataset):
    def __init__(self, train, npoints=6890, regular_sampling=False, normal=False, data_augmentation_Z_rotation=False,
    ...
    def __getitem__(self, index):
        ...
        if self.regular_sampling:
            random_sample = np.random.choice(6890, size=self.npoints,replace=False,p=self.prop)
